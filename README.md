...
---
 ...
 - Multiply the number of <kbd>scroll</kbd> at same time, default is 4. My system is configured to scroll 3 lines per scrolling step made with the mouse wheel, so 4x is perfect for any websites and not too much in the 1080p resolution, PS: I use the same inside as well outside all the browsers windows.
