___
<h1 align="center"># ChromeTabMouse</h1>
___

<img src="https://github.com/acccounttest/ChromeTabMouse-Chrome-Tab-Mouse/raw/main/Gifs/DarkChromePastelFluo.gif" width="1000" height="500">
...
---
 ...
 - Multiply the number of <kbd>scroll</kbd> at same time, default is 4. My system is configured to scroll 3 lines per scrolling step made with the <kbd>mouse wheel</kbd>, so 4x is perfect for any websites and not too much in the 1080p resolution, PS: I use the same inside as well outside all the browsers windows.
