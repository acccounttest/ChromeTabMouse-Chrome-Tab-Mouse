...
> could necessite again 3k more for the configuration choices._    > 
    > _PS:Chrome tab mouse didn't require the script **GoogleSearchColumns** especially, for those that tried the 5e version, try other timings by     >   an another version that permit you less press the right click for reload the script too early_
