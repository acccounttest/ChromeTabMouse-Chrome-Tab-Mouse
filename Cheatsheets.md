...
---
 ...
 - If the script block the clipboard of the system, i suggest you to access the notification area icon and make a <kbd>right click</kbd> on the program icon, note anything else without firstly lose focus of the browser window will fail, only the <kbd>right click</kbd> key down for 3 seconds can reload it, eventually you can close and restart it.
